...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "menu.view.bookmark_panel":     {"ja": "ブックマークパネル (&B)",          "en": "Bookmark Panel (&B)"},
    ...
    # ── 動画情報ダイアログ ────────────────────────────────────────────────────────
    "label.unknown":                    {"ja": "不明",                              "en": "Unknown"},
    "dialog.video_info.filename":       {"ja": "ファイル名",                        "en": "Filename"},
    "dialog.video_info.filesize":       {"ja": "ファイルサイズ",                    "en": "File Size"},
    "dialog.video_info.duration":       {"ja": "再生時間",                          "en": "Duration"},
    "dialog.video_info.resolution":     {"ja": "解像度",                            "en": "Resolution"},
    "dialog.video_info.framerate":      {"ja": "フレームレート",                    "en": "Frame Rate"},
    "dialog.video_info.video_codec":    {"ja": "映像コーデック",                    "en": "Video Codec"},
    "dialog.video_info.audio_codec":    {"ja": "音声コーデック",                    "en": "Audio Codec"},
    # ── ショートカット一覧ダイアログ ────────────────────────────────────────────
    "shortcut.cat.playback":            {"ja": "再生操作",                          "en": "Playback"},
    "shortcut.play_pause":              {"ja": "再生 / 一時停止",                   "en": "Play / Pause"},
    "shortcut.seek_back5":              {"ja": "5秒戻る",                           "en": "Seek back 5s"},
    "shortcut.seek_fwd5":               {"ja": "5秒進む",                           "en": "Seek forward 5s"},
    "shortcut.seek_back1":              {"ja": "-1秒シーク",                        "en": "Seek back 1s"},
    "shortcut.seek_fwd1":               {"ja": "+1秒シーク",                        "en": "Seek forward 1s"},
    "shortcut.seek_back10":             {"ja": "-10秒シーク",                       "en": "Seek back 10s"},
    "shortcut.seek_fwd10":              {"ja": "+10秒シーク",                       "en": "Seek forward 10s"},
    "shortcut.frame_back":              {"ja": "1フレーム戻る（自動一時停止）",      "en": "Back 1 frame (auto-pause)"},
    "shortcut.frame_fwd":               {"ja": "1フレーム進む（自動一時停止）",      "en": "Forward 1 frame (auto-pause)"},
    "shortcut.speed_down":              {"ja": "再生速度を下げる",                   "en": "Decrease speed"},
    "shortcut.speed_up":                {"ja": "再生速度を上げる",                   "en": "Increase speed"},
    "shortcut.cat.volume":              {"ja": "音量操作",                          "en": "Volume"},
    "shortcut.vol_up":                  {"ja": "音量を上げる (+10)",                 "en": "Volume up (+10)"},
    "shortcut.vol_down":                {"ja": "音量を下げる (−10)",                 "en": "Volume down (−10)"},
    "shortcut.mute":                    {"ja": "ミュート切り替え",                   "en": "Toggle mute"},
    "shortcut.cat.ab_loop":             {"ja": "AB ループ操作",                     "en": "AB Loop"},
    "shortcut.set_a_btn":               {"ja": "A点セット",                         "en": "Set A"},
    "shortcut.set_a_btn.desc":          {"ja": "ボタンクリックで A 点を設定",        "en": "Click button to set A point"},
    "shortcut.set_b_btn":               {"ja": "B点セット",                         "en": "Set B"},
    "shortcut.set_b_btn.desc":          {"ja": "ボタンクリックで B 点を設定",        "en": "Click button to set B point"},
    "shortcut.cat.bookmark":            {"ja": "ブックマーク操作",                  "en": "Bookmarks"},
    "shortcut.bookmark_save":           {"ja": "ブックマーク保存",                  "en": "Save Bookmark"},
    "shortcut.bookmark_save.desc":      {"ja": "ボタンクリックで現在の AB 区間を保存", "en": "Click button to save current AB section"},
    "shortcut.undo_delete":             {"ja": "ブックマーク削除を元に戻す（5 秒以内）", "en": "Undo bookmark delete (within 5s)"},
    "shortcut.cat.view":                {"ja": "表示操作",                          "en": "View"},
    "shortcut.bookmark_panel":          {"ja": "ブックマークパネル 表示切り替え (B)", "en": "Toggle bookmark panel (B)"},
    "shortcut.fullscreen":              {"ja": "フルスクリーン 切り替え",            "en": "Toggle fullscreen"},
    "shortcut.fullscreen_exit":         {"ja": "フルスクリーン 解除",               "en": "Exit fullscreen"},
    "shortcut.cat.file":                {"ja": "ファイル操作",                      "en": "File"},
    "shortcut.open_file":               {"ja": "ファイルを開く",                    "en": "Open file"},
    "shortcut.screenshot":              {"ja": "スクリーンショット保存",             "en": "Save screenshot"},
    "shortcut.quit":                    {"ja": "終了",                              "en": "Quit"},
    "shortcut.show_shortcuts":          {"ja": "ショートカット一覧を表示",           "en": "Show shortcuts"},
    # ── 字幕メニュー ──────────────────────────────────────────────────────────
    "menu.playback.subtitle.none":      {"ja": "字幕なし",                          "en": "No Subtitle"},
    # ── デフォルト名 ─────────────────────────────────────────────────────────
    "bookmark.default_name":            {"ja": "ブックマーク {time}",               "en": "Bookmark {time}"},
    # ── ファイルダイアログ タイトル・フィルタ ────────────────────────────────────
    "dialog.open_video.title":          {"ja": "動画ファイルを開く",                  "en": "Open Video File"},
    "filter.video_file":                {"ja": "動画ファイル (*.mp4 *.avi *.mkv *.mov *.wmv *.flv *.webm *.m4v);;すべてのファイル (*)",
                                         "en": "Video Files (*.mp4 *.avi *.mkv *.mov *.wmv *.flv *.webm *.m4v);;All Files (*)"},
    "filter.video_file_ext":            {"ja": "動画ファイル (*{ext});;すべてのファイル (*)",
                                         "en": "Video Files (*{ext});;All Files (*)"},
    "filter.audio_file_ext":            {"ja": "音楽ファイル (*{ext});;すべてのファイル (*)",
                                         "en": "Audio Files (*{ext});;All Files (*)"},
    "filter.json_file":                 {"ja": "JSON ファイル (*.json);;すべてのファイル (*)",
                                         "en": "JSON Files (*.json);;All Files (*)"},
    "filter.subtitle_file":             {"ja": "字幕ファイル (*.srt *.ass *.ssa *.vtt);;すべてのファイル (*)",
                                         "en": "Subtitle Files (*.srt *.ass *.ssa *.vtt);;All Files (*)"},
    "filter.audio_file":                {"ja": "音楽ファイル (*.mp3 *.flac *.aac *.wav *.ogg *.m4a *.opus);;すべてのファイル (*)",
                                         "en": "Audio Files (*.mp3 *.flac *.aac *.wav *.ogg *.m4a *.opus);;All Files (*)"},
    "filter.media_file":                {"ja": "すべてのメディア (*.mp4 *.avi *.mkv *.mov *.wmv *.flv *.webm *.m4v *.mp3 *.flac *.aac *.wav *.ogg *.m4a *.opus);;動画ファイル (*.mp4 *.avi *.mkv *.mov *.wmv *.flv *.webm *.m4v);;音楽ファイル (*.mp3 *.flac *.aac *.wav *.ogg *.m4a *.opus);;すべてのファイル (*)",
                                         "en": "All Media (*.mp4 *.avi *.mkv *.mov *.wmv *.flv *.webm *.m4v *.mp3 *.flac *.aac *.wav *.ogg *.m4a *.opus);;Video Files (*.mp4 *.avi *.mkv *.mov *.wmv *.flv *.webm *.m4v);;Audio Files (*.mp3 *.flac *.aac *.wav *.ogg *.m4a *.opus);;All Files (*)"},
    "msg.no_media_file.title":          {"ja": "エラー",                              "en": "Error"},
    "msg.no_media_file.body":           {"ja": "対応するメディアファイルが見つかりませんでした。", "en": "No supported media files found."},
    "filter.zip_file":                  {"ja": "ZIP ファイル (*.zip)",                "en": "ZIP Files (*.zip)"},
    "filter.zip_file_all":              {"ja": "ZIP ファイル (*.zip);;すべてのファイル (*)",
                                         "en": "ZIP Files (*.zip);;All Files (*)"},
    # VLC 再生エラー
