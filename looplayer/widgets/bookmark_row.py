...
class BookmarkRow(QWidget):
    ...
    def _build(self, bm: LoopBookmark) -> None:
        ...
        # US2: A点 フレーム微調整ボタン
        self.frame_a_minus_btn = QPushButton(t("btn.frame_minus"))
        self.frame_a_minus_btn.setFixedWidth(36)
        self.frame_a_minus_btn.setToolTip(t("tooltip.btn.frame_a_minus"))
        self.frame_a_minus_btn.clicked.connect(lambda: self._adjust_frame("a", -1))
        self.frame_a_plus_btn = QPushButton(t("btn.frame_plus"))
        self.frame_a_plus_btn.setFixedWidth(36)
        self.frame_a_plus_btn.setToolTip(t("tooltip.btn.frame_a_plus"))
        self.frame_a_plus_btn.clicked.connect(lambda: self._adjust_frame("a", +1))

        row2.addWidget(QLabel("A:"))
        row2.addWidget(self.frame_a_minus_btn)
        row2.addWidget(self.frame_a_plus_btn)

        # US2: B点 フレーム微調整ボタン
        self.frame_b_minus_btn = QPushButton(t("btn.frame_minus"))
        self.frame_b_minus_btn.setFixedWidth(36)
        self.frame_b_minus_btn.setToolTip(t("tooltip.btn.frame_b_minus"))
        self.frame_b_minus_btn.clicked.connect(lambda: self._adjust_frame("b", -1))
        self.frame_b_plus_btn = QPushButton(t("btn.frame_plus"))
        self.frame_b_plus_btn.setFixedWidth(36)
        self.frame_b_plus_btn.setToolTip(t("tooltip.btn.frame_b_plus"))
        self.frame_b_plus_btn.clicked.connect(lambda: self._adjust_frame("b", +1))

        row2.addWidget(QLabel("B:"))
        row2.addWidget(self.frame_b_minus_btn)
        row2.addWidget(self.frame_b_plus_btn)

        # US4: ポーズ間隔スピンボックス
        row2.addWidget(QLabel(t("label.pause_interval")))
        self.pause_spin = QDoubleSpinBox()
        self.pause_spin.setToolTip(t("tooltip.pause_interval"))
        ...
        self.tags_btn = QPushButton(t("btn.edit_tags"))
        self.tags_btn.setFixedSize(28, 24)
        self.tags_btn.setToolTip(t("tooltip.btn.edit_tags"))
        self.tags_btn.clicked.connect(self._on_edit_tags)
